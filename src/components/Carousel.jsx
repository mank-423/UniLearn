            ...
            <div className='bg-image'>
                <div className='inset-0'>
                    ...
                    <div className='relative flex gap-16 justify-center items-center pt-4'>
                        <Link to={'/login'}>
                            <button className='px-4 py-2 border-2 border-white text-white bg-blue-500 hover:bg-transparent rounded-xl transition duration-300 ease-in-out hover:rounded-md'>
                                Get started
                            </button>
                        </Link>
